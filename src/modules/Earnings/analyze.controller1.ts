...
//   }
//
//   async parseSearchParams(operName: string, stock_code?: string) {
//     let parseResult: {
...
//
//     const { stockCodeList, stockCountMap, msg } = await this.parseSearchParams(
//       operName,
//       stock_code,
//     );
//
...
//     const { stock_code } = query;
//
//     const { stockCodeList, stockCountMap } = await this.parseSearchParams(
//       operName,
//       stock_code,
//     );
//     const res = await this.analyzeService.exportAnalyzeResult(
//       {
//         stockCode: stockCodeList,
//         start_date: dayjs(Number(query.start_date)).format('YYYYMMDD'),
//         end_date: dayjs(Number(query.end_date)).format('YYYYMMDD'),
